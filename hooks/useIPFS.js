...
export const useIPFS = () => {
    ...
    const uploadMetadata = async (payload) => {
        ...
        const multihashHex = '0x' + multihash.decode(multihash.fromB58String(contentHash)).digest.toString('hex');
    ...
    const decodeMultihash = (hash) => {
        ...
        return 'https://ipfs.io/ipfs/' + multihash.toB58String(multihash.encode(Buffer.from(res, 'hex'), 'sha2-256'));
    };
